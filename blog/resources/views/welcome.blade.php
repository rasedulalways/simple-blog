        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
            <ul
                ...
                @if (Route::has('login'))
                    @auth
                    <li>
                        <a href="{{ url('/dashboard') }}" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Dashboard</a>
                    </li>
                    @else
                    <li>
            ...
            @foreach ($posts as $post)
                <article class="max-w-xs p-3 border flex flex-col relative">
                    <div>
                        ...
                        <p class="mb-6 text-gray-500 dark:text-gray-400">{!! Illuminate\Support\Str::limit($post->content, 100, '...') !!}</p>
                    </div>

                    <!-- Adjusted button positioning using flexbox -->
                    <div class="mt-auto">
                        <a href="{{ route('blog.details',$post->id) }}" class="inline-flex items-center font-medium underline-offset-4 decoration-none decoration-0">
                            <button type="button" class="bg-green-500 hover:bg-green-600 py-2 px-5 rounded-md text-white">
                                Details
                            </button>
                        </a>
                    </div>
