                ...
                <article class="max-w-xs p-3 border flex flex-col relative">
                    ...
                    <div class="mt-auto">
                        <a href="{{ route('blog.details',$post->id) }}"
                            class="inline-flex items-center font-medium underline-offset-4 decoration-none decoration-0">
                            <button type="button"
                                class="bg-green-500 hover:bg-green-600 py-2 px-5 rounded-md text-white">
                                Details
                            </button>
                        </a>
                    </div>
